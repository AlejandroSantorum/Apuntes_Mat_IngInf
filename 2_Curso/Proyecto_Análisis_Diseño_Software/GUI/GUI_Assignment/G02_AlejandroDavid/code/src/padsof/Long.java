...
public class Long extends Offer{
	...
	/**
	 * This checks if two long stay type offers are equal or not
	...
	public Boolean equals(Offer off) {
		...
		if(!this.initialDate.equals(((Long) off).getInitialDate())) return false;
		if(this.minimumPeriod != ((Long)off).getMinimumPeriod()) return false;
		return true;
	}

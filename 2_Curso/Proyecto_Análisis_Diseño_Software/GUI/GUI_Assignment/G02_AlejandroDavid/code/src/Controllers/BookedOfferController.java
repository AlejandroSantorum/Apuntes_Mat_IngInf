 ...
 * This class implements the controller that manages BlockedOfferPanel.
 * It implements ActionListener and ListSelectionListener
 */
public class BookedOfferController implements ActionListener, ListSelectionListener{
	...
	/**
	 * This constructor creates a new BookedOfferController.
	 * It just stores all the information needed to control BookedOfferPanel
	 ...
	 */
	public BookedOfferController(Container window, HashMap<String, JPanel> panels, Application app) {
		this.window = window;
		this.app = app;
	...
	public void valueChanged(ListSelectionEvent arg) {
		...
		((SeeOfferPanel)panels.get("SEE OFFER PANEL")).setPreviousPanel("BOOKED OFFER PANEL");

 ...
 * This class implements the panel where the user can comment offers
 */
public class CommentOfferPanel extends JPanel{
	/* Buttons */
	...
	private JPanel buildTopPanel() {
		...
		this.rateButton = new JButton("Rate offer");
	...
	private JPanel buildMidPanel() {
		...
		text = new JLabel("Comment the offer");
	...
	private JPanel buildDownPanel() {
		...
		rate = new JLabel("Rate the offer");

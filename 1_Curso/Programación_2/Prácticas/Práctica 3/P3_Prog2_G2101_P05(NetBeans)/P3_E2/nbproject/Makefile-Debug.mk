...
${OBJECTDIR}/_ext/45fde427/functions.o: ../../../Desktop/P3_E2/functions.c
	...
	${RM} "$@.d"
	$(COMPILE.c) -g -Wall -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/_ext/45fde427/functions.o ../../../Desktop/P3_E2/functions.c

${OBJECTDIR}/_ext/45fde427/graph.o: ../../../Desktop/P3_E2/graph.c
	${MKDIR} -p ${OBJECTDIR}/_ext/45fde427
	${RM} "$@.d"
	$(COMPILE.c) -g -Wall -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/_ext/45fde427/graph.o ../../../Desktop/P3_E2/graph.c

${OBJECTDIR}/_ext/45fde427/node.o: ../../../Desktop/P3_E2/node.c
	${MKDIR} -p ${OBJECTDIR}/_ext/45fde427
	${RM} "$@.d"
	$(COMPILE.c) -g -Wall -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/_ext/45fde427/node.o ../../../Desktop/P3_E2/node.c

${OBJECTDIR}/_ext/45fde427/p3_e2.o: ../../../Desktop/P3_E2/p3_e2.c
	${MKDIR} -p ${OBJECTDIR}/_ext/45fde427
	${RM} "$@.d"
	$(COMPILE.c) -g -Wall -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/_ext/45fde427/p3_e2.o ../../../Desktop/P3_E2/p3_e2.c

${OBJECTDIR}/_ext/45fde427/queue.o: ../../../Desktop/P3_E2/queue.c
	${MKDIR} -p ${OBJECTDIR}/_ext/45fde427
	${RM} "$@.d"
	$(COMPILE.c) -g -Wall -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/_ext/45fde427/queue.o ../../../Desktop/P3_E2/queue.c

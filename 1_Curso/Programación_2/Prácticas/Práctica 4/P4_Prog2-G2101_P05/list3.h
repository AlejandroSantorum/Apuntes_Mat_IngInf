...
/*Comprueba si la lista contiene ya un elemento pasado como argumento.
 Entrada: Lista donde se quiere comprobar si existe ya un elemento, y el elemento a comprobar.
 Salida: TRUE si el elemento se encuentra en la lista o FALSE en caso contrario.*/
